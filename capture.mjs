...
(async () => {
  ...
  try {
    ...
    await page.goto('http://localhost:5174/create', { waitUntil: 'networkidle0', timeout: 30000 });
    await page.screenshot({ path: 'screenshots/upload_verification.png' });

    console.log("Taking Swap Details screenshot...");
    await page.goto('http://localhost:5174/requests', { waitUntil: 'networkidle0', timeout: 30000 });
    await page.screenshot({ path: 'screenshots/swap_details.png' });

    console.log("Taking Live Chat screenshot...");
    await page.goto('http://localhost:5174/chat/1', { waitUntil: 'networkidle0', timeout: 30000 });
